...
REPLACEMENTS = [
    ...
    (r"from ml_scorer import", "from kraken_ml import"),
    (r"from ml_trainer import", "from kraken_ml import"),
    (r"from fill_tracker import", "from kraken_ops import"),
    (r"from drift_monitor import", "from kraken_ops import"),
    (r"from cost_model import", "from kraken_ops import"),
    (r"from scorecard import", "from kraken_ops import"),
    (r"from telemetry import", "from kraken_ops import"),
    (r"from dashboard_digest import", "from kraken_ops import"),
    (r"from notifications import", "from kraken_ops import"),
    (r"from baseline_manager import", "from kraken_ops import"),
