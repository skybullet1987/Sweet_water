...
def test_rebalance_skips_entry_on_low_volume_ratio(monkeypatch):
    sym = _Symbol("SOLUSD")
    ...
    algo.feature_engine = type("Feat", (), {"current_features": staticmethod(lambda *_args, **_kwargs: {"mom_24": 0.02, "vol_ratio_24h_7d": 1.1})})()
    placed = []
